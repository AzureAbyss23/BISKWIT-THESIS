...
public class Maglaro extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final String UserScore = "userscore"+id+"Maglaro";
            ...
            public void onClick(View v) {
                if(all_ctr < (P_Lesson_Words.length - 1)) {
                    ...
                    if (mic_ctr == 0) {
                        ...
                        SharedPreferences sharedPreferences = getSharedPreferences("Maglaro",Context.MODE_PRIVATE);
        ...
        bot.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                int sound = res.getIdentifier(P_Lesson_Words[all_ctr].replace(" ","_").replace("-","_").replace(",","").replace(".","").toLowerCase().replace("!","").toLowerCase(), "raw", getPackageName());
                ai = MediaPlayer.create(Maglaro.this, sound);
                ai.start();
            }
        });
        ...
        speechRecognizer.setRecognitionListener(new RecognitionListener() {
            ...
            public void onResults(Bundle bundle) {
                ...
                word = data.get(0);
                printSimilarity(word.toString(),P_Lesson_Words[all_ctr].replace(".", "").replace(",","").replace("!",""));
            }
