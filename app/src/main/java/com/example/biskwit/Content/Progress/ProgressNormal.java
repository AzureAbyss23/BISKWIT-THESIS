...
public class ProgressNormal extends AppCompatActivity {
    ...
    TextView score_phonemic,score_sight,score_blending,score_pagbabaybay;
    TextView score_days,score_years,score_synonymous,score_opposite,score_sound;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_progress_normal);
    ...
    private void getData() {
        progressDialog = new ProgressDialog(ProgressNormal.this);
            ...
            public void onResponse(String response) {
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(ProgressNormal.this, error.getMessage().toString(), Toast.LENGTH_LONG).show();
                    }
                });
    ...
    private void showJSONS(String response) {
        ...
        if(!data.isEmpty() && !data2.isEmpty() && !data3.isEmpty()){
            ...
            while(i1.hasNext() && i2.hasNext() && i3.hasNext()) {
                ...
                String mode = i2.next();
                String sco = i3.next();
                if (type.equals("Orton") && mode.equals("Phonemic")) {
