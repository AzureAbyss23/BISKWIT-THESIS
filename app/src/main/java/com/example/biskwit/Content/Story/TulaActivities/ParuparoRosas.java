...
public class ParuparoRosas extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final String UserScore = "userscore"+id+"ParuparoRosas";
            ...
            public void onClick(View v) {
                if(all_ctr < (P_Lesson_Words.length - 1)) {
                    ...
                    if (mic_ctr == 0) {
                        ...
                        intent.putExtra("LessonMode","ParuparoRosas");
    ...
    private void getData() {
        progressDialog = new ProgressDialog(ParuparoRosas.this);
        progressDialog.setTitle("Please wait");
        progressDialog.setMessage("Loading lesson...");
        progressDialog.setCancelable(false);
        progressDialog.show();

        String title = "Ang Paruparo at ang Rosas";
            ...
            public void onResponse(String response) {
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(ParuparoRosas.this, error.getMessage().toString(), Toast.LENGTH_LONG).show();
                    }
                });
    ...
    private void showJSONS(String response) {
        ...
        if(!P_Lesson_Words[0].equals("")){
            ...
            Toast.makeText(ParuparoRosas.this, "No data", Toast.LENGTH_LONG).show();
            progressDialog.dismiss();
        }
    }
    ...
    public void onBackPressed() {
        ...
        new AlertDialog.Builder(this)
                ...
                .setPositiveButton(android.R.string.yes, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface arg0, int arg1) {
                        ParuparoRosas.super.onBackPressed();
                        stopPlaying();
                    }
                }).create().show();
    }
